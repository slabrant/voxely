...
pub mod render;
    ...
    println!("Eyedropper: Press Q, then Left-Click  |  Switch Tool: B / P / Tab");
    println!("Flood fill: Ctrl + Left (Paint)  |  Rectangle: Ctrl + Left-Drag (Build)");
    println!("One-shot actions: F fill, E extrude, M move (each applies once)");
    ...
    println!("(Save As and Open use Wavefront .obj meshes)");
    println!("--------------------------");
